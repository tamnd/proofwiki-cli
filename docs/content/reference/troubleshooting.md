...
Most of these come down to network reality or how proofwiki serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

proofwiki rate-limits like any public site. pw already paces
...
Where a surface is gated, pw reads a cookie or token you supply
...
`pw`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what pw actually did
